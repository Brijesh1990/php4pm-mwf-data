...
$mainurl="http://localhost/mvc-crud-app/admin/";
$baseurl="http://localhost/mvc-crud-app/admin/assets/";
...
<head>
  ...
  <title>Shraddha commerce Admin | Dashboard</title>
...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="index.html" class="logo d-flex align-items-center">
      ...
      <span class="d-none d-lg-block">Shraddha Commerce</span>
    </a>
    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          ...
          <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $_SESSION["txtemail"];?></span>
        </a><!-- End Profile Iamge Icon -->

        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          <li class="dropdown-header">
            <h6><?php echo $_SESSION["txtemail"];?></h6>
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center" href="<?php echo $mainurl;?>?admin-logout" onclick="return confirm('Are you sure to Logout as Admin?')">
